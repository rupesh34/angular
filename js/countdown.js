...
/* Project Preview	==============================================*/
	$('.img-box').click(function(e) {
		...
		slidesHtml = slidesHtml + '</div><nav class="slides-navigation"><a href="#" class="next"><i class="fa fa-angle-right" style="font-size:34px"></i></a><a href="#" class="prev"><i class="fa fa-angle-left" style="font-size:34px"></i></a></nav>';
